...
function applyMode(){ app.dataset.mode=isAdmin?"admin":"viewer"; if(typeof renderSettings==="function")renderSettings(); if(!isAdmin&&(app.dataset.view==="form"||app.dataset.view==="compare")){ if(wishOnly)show("wish"); else if(favOnly)show("list",true); else show(lastMain); } if(app.dataset.view==="stats")renderStats(); }
